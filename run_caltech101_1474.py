...
"""
CAltech101-7数据集: 样本点1474个, 包含6个视图: 1474*48,1474*40,1474*254,1474*198,1474*512,1474*928,分7类
"""
if __name__ == '__main__':
    ...
    # 读取mat文件
    mat = scipy.io.loadmat("./data/Caltech101-7.mat", matlab_compatible=True)
    # 视图数据X
    X = np.array(mat['X'])
    v1 = X[0, 0]
    v2 = X[0, 1]
